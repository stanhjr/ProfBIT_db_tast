...
# Написать management команду для изменения цены, статуса, остатков по товарам.
#     При запуске команды, нужно рандомно установить цену товара (price), статус (status), остатки (remains)